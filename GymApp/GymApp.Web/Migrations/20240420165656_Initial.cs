        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InstagramRedirectUrl = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    LinkedinRedirectUrl = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    XRedirectUrl = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerCategories", x => new { x.CategoryId, x.TrainerId });
                    table.ForeignKey(
                        name: "FK_TrainerCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyIndexes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BodyIndexes_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Memberships_Franchises_FranchiseId",
                        column: x => x.FranchiseId,
                        principalTable: "Franchises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Memberships_Pricings_PricingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_FranchiseId",
                table: "Memberships",
                column: "FranchiseId");

            migrationBuilder.CreateIndex(
                name: "IX_Memberships_PricingId",
                table: "Memberships",
                column: "PricingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerCategories_TrainerId",
